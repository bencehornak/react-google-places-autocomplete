  ...
  switch (injectionState) {
   ...
   default:
    return injectionState = INJECTION_STATE_IN_PROGRESS, new Promise((function(resolve, reject) {
      ...
      language && (src += "&language=" + language), script.src = src, script.async = !0, 
      script.defer = !0;
    ...
    var _componentDidMount = _asyncToGenerator(regeneratorRuntime.mark((function _callee() {
      ...
      return regeneratorRuntime.wrap((function(_context) {
        for (;;) switch (_context.prev = _context.next) {
         case 0:
          if (_this$props3 = this.props, apiKey = _this$props3.apiKey, language = _this$props3.language, 
          onLoadFailed = _this$props3.onLoadFailed, _context.prev = 1, !apiKey) {
            _context.next = 5;
            break;
          }
          return _context.next = 5, injectScript(apiKey, language);
...
exports.geocodeByPlaceId = geocodeByPlaceId, exports.getLatLng = getLatLng, exports.injectScript = injectScript;
